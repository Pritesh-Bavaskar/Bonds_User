...
const BOND_TYPES = [
  {
    key: 'fast-issuance',
    icon: '/assets/images/issuer/why-choose-issuerpro/fast-issurance.svg',
    title: 'Fast Issuance',
    description: 'Launch bonds in days, not months',
  },
  {
    key: 'secure-platform',
    icon: '/assets/images/issuer/why-choose-issuerpro/secure-platform.svg',
    title: 'Secure Platform',
    description: 'Bank-grade security and compliance',
  },
  {
    key: 'ai-suggestions',
    icon: '/assets/images/issuer/why-choose-issuerpro/ai-suggestions.svg',
    title: 'AI Suggestions',
    description: 'Get AI suggestions based on your portfolio',
  },
  {
    key: 'market-analysis',
    icon: '/assets/images/issuer/why-choose-issuerpro/market-analysis.svg',
            ...
            <MotionContainer>
              <m.div variants={varFade().inUp}>
                ...
                >
                  <Box
                    component="img"
                    src="/assets/images/issuer/why-choose-issuerpro/arrow.svg"
                    alt="Arrow"
                    sx={{
                      width: { xs: 40, md: 60 },
                      height: 'auto',
