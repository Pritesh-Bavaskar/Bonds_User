    ...
    <>
        ...
        <Grid container spacing={3} sx={{ mt: 0, mb: 3 }}>
          <Grid xs={12} md={6}>
            ...
            <KYCReviewAndSubmitCard
              ...
              editPath={paths.KYCAddressInfo} // Make sure this path is defined in your routes
          ...
          <Grid xs={12} md={6}>
            ...
            <KYCReviewAndSubmitCard
              ...
              editPath={paths.KYCCompanyDetails} // Make sure this path is defined in your routes
              icon="solar:buildings-bold"
              data={[
                {
            ...
            <KYCReviewAndSubmitCard
              ...
              editPath={paths.KYCBankDetails} // Make sure this path is defined in your routes
            ...
            <KYCReviewAndSubmitCard
              ...
              editPath={paths.KYCSignatories} // Make sure this path is defined in your routes
      ...
      <Container>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 4, mb: 2 }}>
          <Button component={RouterLink} to={paths.KYCSignatories} variant="outlined">
            Back
          </Button>
          <Button component={RouterLink} to={paths.KYCSuccessful} variant="contained">
            Submit For Review
          </Button>
        </Box>
